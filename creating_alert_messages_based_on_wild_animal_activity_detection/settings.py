...
ROOT_URLCONF = 'creating_alert_messages_based_on_wild_animal_activity_detection.urls'
...
WSGI_APPLICATION = 'creating_alert_messages_based_on_wild_animal_activity_detection.wsgi.application'
